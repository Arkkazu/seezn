  ...
  return (
    <div data-name="bg-images" className="fixed left-0 top-0 z-[1] h-lvh w-full lg:h-full">
      ...
      <div data-name="ttls-contents" className="absolute left-1/2 top-1/2 z-20 h-auto w-full -translate-x-1/2 -translate-y-1/2">
        {TITLES.map((t) => (
          <h3 key={t.key} data-name={t.key} className="font-noto-serif absolute left-1/2 top-1/2 z-10 h-auto w-full -translate-x-1/2 text-center text-white text-64 opacity-0" style={{ opacity: 0, visibility: "hidden" }}>
            {t.label}
          </h3>
        ))}
      </div>
    ...
    <LayoutBbq title=".SEEZN (ドット シーズン)" description="群馬県高崎市の完全予約制アウトドアBBQ施設「.SEEZN（ドットシーズン）」公式ページ。準備・火起こし・片付け不要の手ぶらBBQプラン、各種肉コース、設備概要、利用方法と料金情報を掲載しています。ご家族・友人・団体利用まで対応可能な屋外バーベキューサービスの詳細はこちら。">
      <div ref={pageRef} className="">
        ...
        <section data-kvbg="ABOUT" className="min-h-screen mt-[100dvh] pt-[40dvh]">
          <div data-zoom-panel className="relative bg-white mx-auto px-20 py-160 w-full origin-center z-[500]">
                ...
                <div className="flex flex-col gap-60">
                  <div className="flex flex-col gap-24 text-center">
                    <div className="flex items-center justify-center gap-x-16">
                      ...
                      <h2 className="shrink-0 font-noto-serif text-36 font-medium leading-none">Usage flow</h2>

                      <span className="h-px flex-1 bg-black" aria-hidden="true" />
                    </div>
                    <p className="text-16 font-medium leading-none">ご利用の流れ</p>
                  </div>
                  <div className="bg-[#e2dfd3] p-80">
                ...
                <div className="flex flex-col gap-60">
                  <div className="flex flex-col gap-24 text-center">
                    <div className="flex items-center justify-center gap-x-16">
                      ...
                      <h2 className="shrink-0 font-noto-serif text-36 font-medium leading-none">Plan</h2>

                      <span className="h-px flex-1 bg-black" aria-hidden="true" />
                    </div>
                    <p className="text-16 font-medium leading-none">プランのご案内</p>
                  </div>
                  <div className="bg-[#e2dfd3] px-40 py-56 flex flex-col gap-40">
                    <p className="text-20 text-center">
                      下記よりお一人様１コースご注文ください
                      <br />
                      <span className="text-16">（同グループでコースは統一いただきますようお願いします）</span>
                    </p>
                    <div className="grid grid-cols-2 gap-16 pc:gap-24">
                      {planItems.map((item) => (
                                ...
                                <div className="flex">
                                  <div className="bg-orange p-4 flex items-center">
                                    <span className="text-14 font-medium leading-none text-white">
                                      平日限定<span className="text-10">（5/10〜7/10まで）</span>
                                    </span>
                                  </div>
        ...
        <section data-kvbg="SERVICE" className="min-h-screen mt-[100dvh] pt-[60dvh]">
          <div data-zoom-panel className="relative bg-white mx-auto px-20 py-160 w-full origin-center z-[500]">
            <div className="mx-auto max-w-800">
              <div className="flex flex-col gap-160">
                <div className="flex flex-col gap-60">
                  <div className="flex flex-col gap-24 text-center">
                    <div className="flex items-center justify-center gap-x-16">
                      ...
                      <h2 className="shrink-0 font-noto-serif text-36 font-medium leading-none">Our service</h2>

                      <span className="h-px flex-1 bg-black" aria-hidden="true" />
                    </div>
                    <p className="text-16 font-medium leading-none">サービス内容</p>
                  </div>
                  <div className="bg-[#e2dfd3] px-40 py-56 flex flex-col gap-40"></div>
                </div>
              </div>
            </div>
          </div>
        </section>
        <section data-kvbg="USE" className="min-h-screen mt-[100dvh] pt-[40dvh] overflow-hidden">
          <div data-zoom-panel className="relative bg-white mx-auto px-20 py-160 w-full origin-center z-[500]">
            <div className="mx-auto max-w-800">
              <div className="flex flex-col gap-160">
                <div className="flex flex-col gap-60">
        ...
        <section data-kvbg="ACCESS" className="min-h-screen mt-[100dvh] pt-[40dvh] overflow-hidden">
          <div data-zoom-panel className="relative bg-white mx-auto px-20 py-160 w-full origin-center z-[500]">
            <div className="px-20">
        ...
        <div className="fixed right-20 bottom-20 z-[500]">
          <Link className="bg-[rgba(0,0,0,0.7)] w-full pc:w-320 h-96 pc:h-80 flex justify-center items-center pc:hover:opacity-70 duration-500" href="/bbq_business/">
            <div className="relative px-32">
              <p className="text-20 font-semibold font-yu-mincho text-white text-center">
                最大200名様
                <br />
                <span className="relative">
                  <span className="absolute top-1/2 -left-8 -translate-x-full -translate-y-1/2  w-0 h-0  border-y-10 border-y-transparent border-l-10 border-white" />
                  企業様・団体様はこちら
                </span>
              </p>
            </div>
