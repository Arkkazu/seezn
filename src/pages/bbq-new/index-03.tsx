  ...
  return (
    <LayoutBbq title=".SEEZN (ドット シーズン)" description="群馬県高崎市の完全予約制アウトドアBBQ施設「.SEEZN（ドットシーズン）」公式ページ。準備・火起こし・片付け不要の手ぶらBBQプラン、各種肉コース、設備概要、利用方法と料金情報を掲載しています。ご家族・友人・団体利用まで対応可能な屋外バーベキューサービスの詳細はこちら。">
      <div ref={pageRef} className="">
        ...
        {/* 画像区間 */}
        <section data-kvbg="ABOUT" className="min-h-screen mt-[120dvh]">
        ...
        <section data-kvbg="SERVICE" className="min-h-screen mt-[120dvh]">
          <div data-zoom-panel className="relative bg-white mx-auto py-80 w-full origin-center z-[500]">
            <div className="px-20">
              <div className="mx-auto max-w-1220">
        ...
        <section data-kvbg="PLAN" className="min-h-screen mt-[120dvh]">
          <div data-zoom-panel className="relative bg-white mx-auto py-80 w-full origin-center z-[500]">
            <div className="px-20">
              <div className="mx-auto max-w-1220">
        ...
        <section data-kvbg="USE" className="min-h-screen mt-[120dvh] overflow-hidden">
          <div data-zoom-panel className="relative bg-white mx-auto py-80 w-full origin-center z-[500]">
            <div className="px-20">
        ...
        <section data-kvbg="ACCESS" className="min-h-screen mt-[120dvh] overflow-hidden">
          <div data-zoom-panel className="relative bg-white mx-auto py-80 w-full origin-center z-[500]">
            <div className="px-20">
              <div className="mx-auto max-w-1220">
                <div className="flex items-end gap-x-16">
