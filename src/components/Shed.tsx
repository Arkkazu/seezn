...
export const LayoutBbq = ({ title, description, image = "/ogp.jpg", url, type = "website", siteName = "サイト名", locale = "ja_JP", twitterCard = "summary_large_image", children }: LayoutBbqProps) => {
